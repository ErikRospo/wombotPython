        ...
        return (
            <div id="toolbar-base" style={{"height":(this.state.closed?"3em":"400px")}}>
                <div >
                    ...
                    <br />
                    <div id="selector" hidden={this.state.closed}>
                        <label>
                            <input type="radio" name="Tool" onClick={()=>this.setState({tool:0})} checked={this.state.tool===0}/>
                            Eraser <BsEraserFill></BsEraserFill>
                        </label>
                        <br />
                        <label>
                            <input type="radio" name="Tool" onClick={()=>this.setState({tool:1})} checked={this.state.tool===1}/>

                            Pen <BsPenFill></BsPenFill>
                        </label><br />
                        <label>
                            <input type="radio" name="Tool" onClick={()=>this.setState({tool:2})} checked={this.state.tool===2}/>
