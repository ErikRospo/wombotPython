...
const argc = yargs(hideBin(process.argv))
  ...
  .positional("style", {
    ...
    default: 3,
    describe:
      'The style of the AI: chooses a collection of (presumed) GANs chained together, yielding different "styles"'
  })
  .option("times", {
    type: "number",
    default: 1,
    describe:
      "The number of times to request an image; setting this to a number higher than 10 will cause issues with the built-in ratelimiter!"
  })
  .option("quiet", {
    type: "boolean",
    default: false,
    describe:
      "Silences most of the output, only printing the paths of the downloaded files."
  })
  .option("inter", {
    type: "boolean",
    default: false,
  ...
  .option("nofinal", {
    ...
    default: false,
    describe:
      "When set, disables the download of the final image. Instead, its url is printed."
  })
  .option("noasync", {
    type: "boolean",
    default: false,
    describe:
      "When set, disables the asyncronous generation. May avoid rate limiting."
  })
  .alias("h", "help")
  .parse();
